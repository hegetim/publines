...
import { DrawingConfig, bcWidth, drawMetroStation, drawSLine, mkBcMetrics } from "./StorylineUtils"
...
export const StorylineTest = () => {
  ...
  const commons = { fill: "none", stroke: "black", strokeWidth: 1.5 };
  return <svg viewBox={`0 0 ${70 + w1 + w2 + w3 + w4} 60`}>
    ...
    <path fill="white" stroke="black" strokeWidth={1} d={drawMetroStation(info, 25 + w1, 2, 5)} />
  </svg>
}
